                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        @if($car->main_image)
                                            <img src="{{ Storage::url($car->main_image) }}" alt="{{ $car->name }}" class="me-3"
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <p class="mb-1"><strong>Category:</strong> {{ $car->category->name ?? 'N/A' }}</p>
                                        <p class="mb-1"><strong>Mise en Service:</strong>
                                            {{ $car->mise_en_service_date ? date('d/m/Y', strtotime($car->mise_en_service_date)) : 'N/A' }}
                                        </p>
                                        <p class="mb-0"><strong>Mileage:</strong> {{ number_format($car->mileage) }} km</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                                ...
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <p class="text-xs text-secondary mb-0">
                                                            {{ $documents->assurance_company ?? 'N/A' }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ $documents->assurance_number ?? 'N/A' }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ $documents->carte_grise_number ?? 'N/A' }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">
                                            ...
                                            <td>
                                                @if($documents && $documents->file_carte_grise)
                                                    <a href="{{ Storage::url($documents->file_carte_grise) }}" target="_blank"
                                                        class="btn btn-link btn-sm text-secondary mb-0">
                                                        <i class="fas fa-file-pdf me-2"></i> View
                                                    </a>
                                                @else
                                            ...
                                            <td>
                                                ...
                                                @if($documents && $documents->visite_technique_date)
                                                    <p class="text-xs text-secondary mb-0">Last check:
                                                        {{ date('d/m/Y', strtotime($documents->visite_technique_date)) }}</p>
                                                @endif
                                            </td>
                                            <td>
                                                @php
                    ...
                    <div class="modal-body">
                        ...
                        <div id="assurance_fields" class="document-specific-fields">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="assurance_number" name="assurance_number"
                                        required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="assurance_company" name="assurance_company"
                                        required>
                        ...
                        <div id="carte_grise_fields" class="document-specific-fields">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="carte_grise_number" name="carte_grise_number"
                                    required>
                        ...
                        <div id="visite_technique_fields" class="document-specific-fields">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="inspection_date" name="visite_technique_date">
